    ...
    <section className="py-32 bg-white">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl lg:text-5xl font-serif text-black-matte mb-6">Luxury Memberships</h2>
          <p className="max-w-2xl mx-auto text-charcoal/60 font-light">
            Unlock a world of unparalleled benefits, priority services, and exclusive experiences designed for our most valued clientele.
          </p>
        </div>
            ...
            >
              ...
              <div className="mb-8">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="font-serif text-4xl">{m.price}</span>
              ...
              <button className={cn("w-full py-4 text-[11px] tracking-[0.2em] uppercase transition-colors duration-300 font-bold", m.btn)}>
                Join Now
              </button>
            </motion.div>
          ))}
